...
//            window1.setFrameOrigin(NSScreen.mainScreen()!.frame.)
            ...
            text1.maxSize = CGSize(width: CGFloat.greatestFiniteMagnitude, height: CGFloat.greatestFiniteMagnitude)
            
            text1.isVerticallyResizable = true
            text1.isHorizontallyResizable = true
            
            if wordwrap {
                /// Matching width is also important here.
                let sz1 = scroll1.contentSize
                text1.frame = CGRect(x: 0, y: 0, width: sz1.width, height: 0)
                text1.textContainer!.containerSize = CGSize(width: sz1.width, height: CGFloat.greatestFiniteMagnitude)
...
//                text1.frame = CGRect(x: 0, y: 0, width: 0, height: 0)
                ...
                text1.textContainer!.containerSize = CGSize(width: CGFloat.greatestFiniteMagnitude, height: CGFloat.greatestFiniteMagnitude)
            }
