...
static void THE_CORE_PART_OF_THIS_EXAMPLE()
{
	/*!
	 ...
	 -	"Item 4" means the second menu will be visible to you.
	...
	NSMenuItem*	m4	=	[[NSMenuItem alloc] initWithTitle:@"Item 4" action:s1 keyEquivalent:[NSString stringWithCharacters:&c1 length:1]];
	NSMenuItem*	m5	=	[[NSMenuItem alloc] initWithTitle:@"Item 5" action:s1 keyEquivalent:@"q"];
	...
	[m4 setKeyEquivalentModifierMask:0];
	[m5 setKeyEquivalentModifierMask:0];
}
